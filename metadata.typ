...
#let naslov = "Софтверско решење за дводимензионални ортогонални проблем ранца са ротацијом"  // Наслов рада
#let autor = "Маша Иванов"

// На енглеском
#let naslov_eng = "А software solution for the two-dimensional orthogonal knapsack problem with rotation"
...
#let zadatak = [
    Дизајнирати и имплементирати софтверско решење за дводимензионални ортогонални
    проблем ранца са дозвољеном ротацијом правоугаоника за 90 степени. Реализовати
    генетски алгоритам за избор подскупа правоугаоника који максимизује искоришћену
    површину и минимизује празан простор на задатој површини. Декодирање хромозома
    треба реализовати помоћу више хеуристика за постављање правоугаоника и
    обезбедити механизам за њихово поређење. Потребно је реализовати визуализацију
    решења као и поређење резултата са другим хеуристикама.
